      ...
      <div class="card-body"><br>
        ...
        <div class="col-12">
          ...
          <div class="col-12">
            ...
            <input type="number" class="form-control" id="jumlah_produksi" name="jumlah_produksi" placeholder="Masukkan Jumlah Produksi" required>
          </div>
          <div class="col-12">
            <label for="tanggal_produksi" class="form-label">Tanggal Produksi</label>
            <input type="date" class="form-control" id="tanggal_produksi" name="tanggal_produksi" placeholder="Masukkan Tanggal Produksi" required>
          </div>
          <div class="col-12">
            <label for="durasi_produksi" class="form-label">Durasi Produksi</label>
            <input type="text" class="form-control" id="durasi_produksi" name="durasi_produksi" placeholder="Masukkan Durasi Produksi" required>
          </div>
          <div class="col-12">
            <label for="pembuatan_ke" class="form-label">Pembuatan Ke</label>
            <input type="number" class="form-control" id="pembuatan_ke" name="pembuatan_ke" placeholder="Masukkan Pembuatan Ke" required>
          </div>
