...
<div class="container-fluid">
    <div class="card">
      <div class="card-header">
        ...
        <a href="{{ route('pdfProduksi') }}" target="_blank" class="btn btn-warning"><i class="fas fa-print"></i> Cetak PDF</a>
      </div>
    </div>
    <div class="row">
        <div class="col-12">
                    ...
                    <table class='table datatable table-striped table-bordered' id="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('viewProduksi', $row->id) }}" class="btn icon btn-primary" data-bs-target="{{ $row->id }}"><i class="fas fa-eye"></i>  </a>
